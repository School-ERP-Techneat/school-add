      ...
      <div className="flex flex-wrap gap-2">
        {item.teachers.length > 0 ? (
          item.teachers.map((t, i) => (
            <span
              key={i}
              className="px-2 py-1 text-xs rounded-full bg-indigo-100 dark:bg-indigo-800 text-indigo-700 dark:text-indigo-100 font-medium"
            >
              {t}
            </span>
          ))
...
const SubjectListPage = () => (
  ...
  >
    ...
    >
      <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">📚 All Subjects</h1>
